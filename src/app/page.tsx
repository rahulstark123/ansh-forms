          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pt-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2.5">
                ...
                <a href="tel:+919625727372" className="flex items-center gap-2 text-xs font-bold text-violet-400 hover:text-violet-300 transition-colors duration-200">
                ...
                <a
                  ...
                  className="flex items-center gap-2 text-xs font-bold text-emerald-400 hover:text-emerald-300 transition-colors duration-200"
